...
- **[docs/STYLE.md](docs/STYLE.md)** — Design tokens, color scheme, typography, component conventions, dark/light mode approach. Read this before creating or editing any visual component.

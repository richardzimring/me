  ...
  roles={[
    {
      ...
      bullets: [
        'Lead development of Maven, a generative AI sports research platform — designed the model-agnostic (Bedrock, Azure, Vertex) file-system based, SQL writing agent architecture that increased accuracy from 30% to 82% and made the system league-agnostic across MLB, NFL, NBA, NHL, CFB, and CBK',
    ...
    },
    {
      ...
      bullets: [
        'Designed and shipped a TypeScript data-integrity microservice on AWS Lambda to validate migrations of upstream data sources in production warehouses',
      ],
    },
  ]}
/>
...
- **AI / LLMs**: Anthropic, OpenAI, Bedrock, Vertex AI, Azure AI Foundry; agent architectures, RAG over vector + full-text search, LLMOps (evals, dataset curation, LLM-as-judge, Langfuse, OpenTelemetry)
- **Data**: PostgreSQL, DynamoDB, SingleStore, OpenSearch, Redis
- **Infrastructure**: AWS (Lambda, ECS/Fargate, API Gateway, Step Functions, SQS, S3, Cognito, CDK), Auth0, Docker, event-driven architectures, streaming protocols (WebSockets, SSE)
- **Frontend**: React, React Native / Expo, Astro, TanStack Query, GraphQL, Vite

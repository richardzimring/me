...
<ExperienceTimeline
  ...
  roles={[
    ...
    },
    {
      ...
      bullets: [
        'Built and demoed the prototype that launched NLI (Natural Language Interface) at engineering all-hands to 800+ engineers — a chat interface over the Radar360 sports data catalog that generated OLAP DSL through multi-step prompt flows and ran RAG over an OpenSearch index of expert SQL queries from internal research Slack channels',

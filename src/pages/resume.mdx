...
- **AI / LLMs**: Agent architectures, MCP, tool use, memory, compaction, RAG, LLMOps (evals, dataset curation, LLM-as-judge, Langfuse, OpenTelemetry), LLM fine tuning; AWS Bedrock, Google Vertex AI, Azure AI Foundry
...
- **Frontend**: React, React Native / Expo, Astro, TanStack Query, GraphQL, Vite; Tailwind, shadcn/ui, Material UI

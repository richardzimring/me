  ...
  roles={[
    {
      ...
      bullets: [
        ...
        'Built a Claude Agent SDK–powered GitLab MR reviewer as a side project — started on my team, rolled it out to other teams, then drove its adoption by central engineering as the company-wide multi-tenant stack',

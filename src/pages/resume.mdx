  ...
  roles={[
    {
      ...
      bullets: [
        'Lead development of Maven, a generative AI sports research platform that answers natural-language questions primarily by writing and executing SQL against Sportradar databases — designed the SQL Agent architecture that increased accuracy from 30% to 82% and made the system league-agnostic across MLB, NFL, NBA, NHL, CFB, and CBK',
        'Simplified Maven from a multi-step Step Function pipeline to an agentic loop in a single Lambda, migrated to the Vercel AI SDK for model-agnostic support (OpenAI, Anthropic, Gemini, Bedrock), and shipped production features including a Slack integration with our Research team for human verification, persistent conversations, collapsible reasoning, inline tables with metadata extraction, and usage analytics — Maven insights were used on-air during the 2025 World Series on FOX',
      ],
    },
    {
